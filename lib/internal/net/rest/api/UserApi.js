...
var UserApi = function () {
  ...
  _createClass(UserApi, null, [{
    ...
    value: function getRefreshToken() {
      return _Store2.default.refreshToken;
    }
  }, {
    key: 'setRefreshToken',
    value: function setRefreshToken(token) {
      _Store2.default.token = '';
      _Store2.default.refreshToken = token;
    ...
    */
    ...
    value: function updateUser(update) {
      ...
      return _Client2.default.request("PATCH", '/v1/user', update, true);
    }
    ...
    value: function getUserTokens() {
      ...
      return _Client2.default.request('GET', '/v1/user/tokens', '', true);
    }
    ...
    value: function verifyUserToken(verification) {
      ...
      return _Client2.default.request('POST', '/v1/user/verify_token', verification, true);
    }
    ...
    value: function resetPassword(token, tokenType) {
      ...
      return _Client2.default.request('POST', '/v1/user/reset_token', payload, false);
    }
    ...
    */
    ...
    value: function sendTokenVerification(token, tokenType) {
      ...
      return _Client2.default.request('POST', '/v1/user/reset_token_verification', payload, false);
    }
    ...
    value: function getGuestToken() {
      return _Client2.default.request('POST', '/v1/user/guest', '', false).then(function (data) {
    ...
    value: function encodeAssetProvider(url) {
      var aP = _Store2.default.assetProvider;
      var aPlen = aP.length;
    ...
    value: function addUserToken(payload) {
       ...
       * }
       */
      return _Client2.default.request('POST', '/v1/user/tokens', payload, true);
    }
  }, {
    key: 'deleteUserToken',
