...
var _Chat = require('./manager/Chat');

var _Chat2 = _interopRequireDefault(_Chat);

var _ChatApi = require('../internal/net/rest/api/ChatApi');
...
var Blockv = function Blockv(payload) {
    ...
    var chatApi = new _ChatApi2.default(this.client);

    this.Chat = new _Chat2.default(chatApi);
    this.WebSockets = new _WebSockets2.default(this.store, this.client);
