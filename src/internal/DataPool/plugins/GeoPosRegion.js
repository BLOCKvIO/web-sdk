...
import VatomicWebSocket from "../VatomicWebSocket"
...
export default class GeoPosRegion extends BLOCKvRegion {
    ...
    constructor(dataPool, coordinates) {
        ...
        if (!coordinates || !coordinates.top_right || !coordinates.top_right.lat || !coordinates.top_right.lon 
            || !coordinates.bottom_left || !coordinates.bottom_left.lat || !coordinates.bottom_left.lon)
        ...
        Events.registerEvent('websocket.open', this.onWebSocketOpen)
    ...
    close() {
        ...
        // Remove listeners
        Events.removeEventListener('websocket.open', this.onWebSocketOpen)
    ...
    sendRegionCommand() {
        ...
        VatomicWebSocket.sendMessage(cmd)
    ...
    async load() {
        ...
        // Fetch data
        let response = await Request.post('/vatom/geodiscover', {
    ...
    processMessage(msg) {
        ...
        // Fetch vatom payload
        Request.post('/user/vatom/get', { ids: [vatomID] }).then(response => {
